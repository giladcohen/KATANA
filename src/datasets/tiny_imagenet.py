...
from src.utils import get_all_files_recursive, convert_grayscale_to_rgb, inverse_map
...
class TinyImageNet(VisionDataset):
    ...
    def parse_test_data(self):
        """Parsing the validation data in imagenet:
            ...
            total 1M
            -rw-rw-r-- 1 1M Jul 24 14:47 val_annotations.txt
            drwxrwxr-x 2 1M Jul 24 14:47 images

        images has 10000 images (200 x 50): 50 images of each of the 200 classes.
        -rw-rw-r-- 1 1M Jul 24 14:47 val_5261.JPEG
        -rw-rw-r-- 1 1M Jul 24 14:47 val_2584.JPEG
        -rw-rw-r-- 1 1M Jul 24 14:47 val_1664.JPEG
        """
